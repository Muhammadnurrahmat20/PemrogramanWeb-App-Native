...
/**
* Proses untuk memperbaharui data anggota
*/
if ($cmdSimpan == "Simpan" && $hdnID != "" && $txtKodeAnggota != "" && $txtNamaAnggota != "")
{
    ...
    {
        $notifikasi = "<div class='alert alert-success alert-dismissible fade show' role='alert'>
        Sukses memperbaharui sebuah data anggota. 
        Klik tombol Batal untuk kembali ke halaman daftar anggota.
        <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button></div>";
    }
    else
    {
        $notifikasi = "<div class='alert alert-danger alert-dismissible fade show' role='alert'>
        Terjadi kesalahan pada sistem. Data tidak dapat diperbaharui.
        <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button></div>";
    }
}
